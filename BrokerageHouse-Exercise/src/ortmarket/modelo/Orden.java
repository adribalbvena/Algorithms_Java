...
public class Orden implements Apreciable {
	...
	public String obtenerDatosParaHistorial() {
		return "Codigo: " + instrumentoFinanciero.getCodigo() + " - " + instrumentoFinanciero.getNombre() + "("
				+ instrumentoFinanciero.getEmisor() + ")";
	}

	@Override
	public double obtenerPrecio() {
		return this.cantidad * this.instrumentoFinanciero.obtenerPrecio();
	}
}
